...
\begin{document}
	...
	\section*{Abstract}
	 ...
	 The rapid growth of dynamic data has enforced the database vendors to search for an alternative of the classical database management system like RDBMS. XML and NoSQL databases are two emerging non-relational database management systems after the popularity of Big Data. This thesis focuses on the study of XML and NoSQL. The migration of data from XML to NoSQL database and the performance of both systems based on the standard queries will be examined.
	 \par 
	 From the study it is found that the secondary indexes used made some of the NoSQL database efficient comparison to XML database. On the other side, the query language of XML database XQuery very easy to work with these databases compare to NoSQL databases.
	 
	 the query language used in XML database XQuery is powerful and easy 
