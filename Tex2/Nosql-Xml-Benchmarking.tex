...
\begin{document}
	...
	XML and NoSQL database are two emerging non-relational database management systems to store and process the semi-structured and unstructured data.
	This master thesis focuses on these new databases. The migration of data from XML database to NoSQL databases and the performance of both systems will be examined.
	% The rapid growth in bigdata has enforce the database venders to search for an alternative to classical database management systems like RDBMS.
