...
\par
For the analysis, we have selected six different size of XMark dataset based on the \textit{xmlgen} factors 0.001, 0.01, 0.1, 1, 10 and 20 that generated the data which generate the dataset of 111 KB, 1.1 MB, 11 MB, 111MB, 1.1GB and 2.2 GB respectively. The size of the database for each of these individual system can be different.  All the database systems are used in standmode for benchmarking. 